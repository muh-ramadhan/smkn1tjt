    ...
    <nav class="navbar sidebar navbar-expand-xl navbar-dark bg-dark">
        ...
        <div class="d-flex align-items-center">
            <a class="navbar-brand" href="index.html">
                <img class="navbar-brand-item" src="<?= base_url(); ?>assets/images/logo-light.svg" alt="">
            </a>
        </div>
            ...
            <div class="offcanvas-body sidebar-content d-flex flex-column bg-dark">
                ...
                <ul class="navbar-nav flex-column" id="navbar-sidebar">
                    ...
                    <li class="nav-item">
                        <a class="nav-link" data-bs-toggle="collapse" href="#collapsepage" role="button" aria-expanded="false" aria-controls="collapsepage">
                            <i class="bi bi-basket fa-fw me-2"></i>Buku
                        </a>
                        <!-- Submenu -->
                        <ul class="nav collapse flex-column" id="collapsepage" data-bs-parent="#navbar-sidebar">
                            <li class="nav-item"> <a class="nav-link" href="admin-course-list.html">Semua Buku</a></li>
                            <li class="nav-item"> <a class="nav-link" href="admin-course-category.html">Kategori Buku</a></li>
                        </ul>
                    </li>
                ...
                <div class="px-3 mt-auto pt-3">
                    <div class="d-flex align-items-center justify-content-between text-primary-hover">
                        ...
                        <a class="h5 mb-0 text-body" href="<?= base_url(); ?>" data-bs-toggle="tooltip" data-bs-placement="top" title="Beranda">
            ...
            <div class="container-fluid p-0">
                <div class="d-flex align-items-center w-100">
                    ...
                    <div class="d-flex align-items-center d-xl-none">
                        <a class="navbar-brand" href="index.html">
                            <img class="light-mode-item navbar-brand-item h-30px" src="<?= base_url(); ?>assets/images/logo-mobile.svg" alt="">
                            <img class="dark-mode-item navbar-brand-item h-30px" src="<?= base_url(); ?>assets/images/logo-mobile-light.svg" alt="">
                        </a>
                    </div>
                    <!-- Logo END -->
                        ...
                        <ul class="navbar-nav flex-row align-items-center">
                            ...
                            <li class="nav-item ms-2 ms-md-3 dropdown">
                                ...
                                <ul class="dropdown-menu dropdown-animation dropdown-menu-end shadow pt-3" aria-labelledby="profileDropdown">
                                    ...
                                    <!-- Links -->
                                    <li><a class="dropdown-item" href="#"><i class="bi bi-person fa-fw me-2"></i>Ubah Profil</a></li>
                                    <li><a class="dropdown-item" href="#"><i class="bi bi-gear fa-fw me-2"></i>Pengaturan Akun</a></li>
                                    <li><a class="dropdown-item" href="#"><i class="bi bi-info-circle fa-fw me-2"></i>Bantuan</a></li>
                ...
                scanButton.addEventListener("click", async () => {
                    try {
                        ...
                        ndef.addEventListener("reading", ({
                            ...
                            idDisplay.textContent = `${serialNumber}`;
                        });

                        ndef.addEventListener("readingerror", () => {
                            idDisplay.textContent = "Argh! Cannot read data from the NFC tag. Try another one?";
                        });

                        idDisplay.textContent = "Scanning NFC tag...";
                    } catch (error) {
                        idDisplay.textContent = "Argh! " + error;
                    }
                });
            </script>
            ...
            <div class="row g-4 mb-4">
                ...
                <div class="col-sm-6">
                    <div class="text-center p-4 bg-success bg-opacity-10 border border-success rounded-3">
                        <a href="<?=base_url();?>Pinjam-Buku" class="btn btn-link p-0 mb-0">
                        <h2 class="mb-0 fs-1 text-success">Pinjam Buku</h2>
                        </a>
                    </div>
                </div>
                ...
                <div class="col-sm-6">
                    <div class="text-center p-4 bg-warning bg-opacity-10 border border-warning rounded-3">
                        <h2 class="mb-0 fs-1 text-warning">Kembalikan Buku</h2>
                    </div>
                </div>
            </div>
            <!-- Course boxes END -->
                    ...
                    <div class="card card-body bg-warning bg-opacity-15 p-4 h-100">
                        <div class="d-flex justify-content-between align-items-center">
                            ...
                            <div>
                                ...
                                <span class="mb-0 h6 fw-light">Buku Digunakan</span>
                            </div>
                            <!-- Icon -->
                    ...
                    <div class="card card-body bg-purple bg-opacity-10 p-4 h-100">
                        <div class="d-flex justify-content-between align-items-center">
                            ...
                            <div>
                                ...
                                <span class="mb-0 h6 fw-light">Buku Belum Kembali</span>
                            </div>
                            <!-- Icon -->
                    ...
                    <div class="card card-body bg-primary bg-opacity-10 p-4 h-100">
                        <div class="d-flex justify-content-between align-items-center">
                            ...
                            <div>
                                ...
                                <span class="mb-0 h6 fw-light">Koleksi Buku Aktif</span>
                            </div>
                            <!-- Icon -->
                    ...
                    <div class="card card-body bg-success bg-opacity-10 p-4 h-100">
                        <div class="d-flex justify-content-between align-items-center">
                            ...
                            <div>
                                ...
                                <span class="mb-0 h6 fw-light">Total Koleksi Buku</span>
                            </div>
                            <!-- Icon -->
                ...
                <div class="col-xxl-8">
                    <div class="card shadow h-100">
                        ...
                        <div class="card-header p-4 border-bottom">
                            <h5 class="card-header-title">Aktivitas Peminjaman</h5>
                        </div>
            ...
            <div class="row g-4">
                ...
                <div class="col-lg-6 col-xxl-4">
                    <div class="card shadow h-100">
                        ...
                        <div class="card-header border-bottom d-flex justify-content-between align-items-center p-4">
                            <h5 class="card-header-title">Pecinta Buku</h5>
                            <a href="#" class="btn btn-link p-0 mb-0">Lihat Semua</a>
                        </div>
                        ...
                        <div class="card-body p-4">
                            ...
                            <div class="d-sm-flex justify-content-between align-items-center">
                                ...
                                <!-- Button -->
                                <a href="#" class="btn btn-sm btn-light mb-0">Lihat</a>
                            </div>
                            <!-- Instructor item END -->
                ...
                <div class="col-lg-6 col-xxl-4">
                    <div class="card shadow h-100">
                        ...
                        <!-- Card header -->
                        <div class="card-header border-bottom d-flex justify-content-between align-items-center p-4">
                            <h5 class="card-header-title">Grafik Jurusan</h5>
                            <a href="#" class="btn btn-link p-0 mb-0">Lihat Semua</a>
                        </div>
                        ...
                        <div class="card-body p-4">
                            ...
                            <ul class="list-group list-group-borderless mt-3">
                                <li class="list-group-item"><i class="text-primary fas fa-circle me-2"></i>Teknik Komputer dan Jaringan</li>
                                <li class="list-group-item"><i class="text-success fas fa-circle me-2"></i>Teknik Kendaraan Ringan Otomotif</li>
                                <li class="list-group-item"><i class="text-warning fas fa-circle me-2"></i>Nautika Kapal Penangkap Ikan</li>
                                <li class="list-group-item"><i class="text-danger fas fa-circle me-2"></i>Nautika Kapal Penangkap Ikan</li>
                            </ul>
                        </div>
                    </div>
                    <!-- Card body END -->
