        ...
        <div class="page-content-wrapper border">
            ...
            <div class="row mb-3">
                <div class="col-12 d-sm-flex justify-content-between align-items-center">
                    ...
                    <a href="<?= base_url(); ?>admin/tambah-kategori-news-and-blog" class="btn btn-sm btn-primary mb-0">Tambah</a>
                </div>
            </div>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div class="d-flex align-items-center position-relative">
                                                <h6 class="table-responsive-title mb-0 ms-2">
                                                    <a href="<?= base_url('admin/detail-kategori-news-and-blog/' . $value['id_kategori_news_and_blog']); ?>" class="stretched-link"><?= $value['judul_kategori_news_and_blog']; ?></a>
                                                </h6>
                                            </div>
                                        </td>
                                        <td>
                                        ...
                                        <td>
                                            <?php if ($value['status_kategori_news_and_blog'] == '1') : ?>
                                                <a href="<?= base_url('admin/nonaktif-kategori-news-and-blog/' . $value['id_kategori_news_and_blog']); ?>">
                                                    <span class="badge bg-success bg-opacity-15 text-success">Aktif</span>
                                                </a>
                                            <?php elseif (is_null($value['status_kategori_news_and_blog'])) : ?>
                                                <a href="<?= base_url('admin/aktif-kategori-news-and-blog/' . $value['id_kategori_news_and_blog']); ?>">
                                                    <span class="badge bg-secondary bg-opacity-15 text-secondary">Nonaktif</span>
                                                </a>
                                            <?php endif; ?>
                                        </td>
                                        <td>
                                            <a href="<?= base_url('admin/detail-kategori-news-and-blog/' . $value['id_kategori_news_and_blog']); ?>" class="btn btn-success-soft btn-round me-1 mb-1 mb-md-0" data-bs-toggle="tooltip" data-bs-placement="top" title="Ubah News And Blog" data-bs-original-title="Ubah">
                ...
                <div class="modal-body">
                    <div class="text-center">
                        ...
                        <div class="btn-group justify-content-center mb-2" role="group" aria-label="Pilihan">
                            <a href="<?= base_url('admin/hapus-sementara-kategori-news-and-blog/' . $value['id_kategori_news_and_blog']) ?>" class="btn btn-success mx-2">Iya</a>
