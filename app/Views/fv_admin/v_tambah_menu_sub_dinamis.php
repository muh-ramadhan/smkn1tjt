...
<main>
    ...
    <div class="page-content">
        ...
        <div class="page-content-wrapper border">
            ...
            <?= form_open_multipart('admin/simpan-menu-sub-dinamis') ?>
            <?= csrf_field() ?>
            <div class="row g-4">
                ...
                <div class="col-lg-6">
                    ...
                    <select class="form-select js-choice z-index-9 border-0 bg-light" aria-label=".form-select-sm" name="id_menu_dinamis" required>
                        <option value="NULL" disabled selected>Pilih Menu Dinamis</option>
                        <?php foreach ($AmbilMenuDinamisModel as $menuDinamis) : ?>
                            <option value="<?= $menuDinamis['id_menu_dinamis']; ?>">
                ...
                <div class="col-md-6">
                    ...
                    <input class="form-control" type="text" placeholder="Masukkan Judul Menu" name="nama_menu_sub_dinamis" required>
                ...
                <div class="col-md-6">
                    ...
                    <input class="form-control" type="text" placeholder="Masukkan URL Menu, Jika Kosong Isikan Tanda #" name="url_menu_sub_dinamis">
                ...
                <div class="col-md-6">
                    ...
                    <div class="d-sm-flex">
                        <div class="form-check radio-bg-light me-4">
                            <input class="form-check-input" type="radio" value="1" name="status_menu_sub_dinamis" required>
                            <label class="form-check-label" for="flexRadioDefault1">
                                <p class="text-success">Aktif</p>
                            </label>
                        </div>
                        <div class="form-check radio-bg-light me-4">
                            <input class="form-check-input" type="radio" value="NULL" name="status_menu_sub_dinamis" required>
